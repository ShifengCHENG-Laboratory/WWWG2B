...
tabix="/public/home/fengcong/anaconda2/bin/tabix"
python3 = "/public/home/fengcong/anaconda2/envs/py3/bin/python"
normaldepth="/public/agis/chengshifeng_group/fengcong/WGRS/software/Fc-code/normalization_depth_from_mosdepth_output.py"
...
if __name__ == "__main__":
    ...
    # ouput the sample depth to a tab delimited file
    file_name = "sample_depth.txt"
    if args.excel:
        file_name = args.excel.split(".")[0]+".depth.txt"
    elif args.output:
        file_name = args.output.split(".")[0]+".depth.txt"
    else:
        pass

    with open(file_name,"w") as f:
        f.write("sample\t"+"\t".join(map(str,header_line))+"\n")
        for sample in sample_order:
            f.write(sample+"\t"+"\t".join(map(str,sample_depth[sample]))+"\n")
